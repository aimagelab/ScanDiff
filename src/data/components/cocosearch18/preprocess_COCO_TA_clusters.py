...
fixation_root = './data/cocosearch18'
...
for scanpath in fixations:
    if scanpath['split'] == 'train': #only consider test and validation sets.
        continue
...
np.save(join('clusters_TA_512_384.npy'), clusters, allow_pickle=True)
