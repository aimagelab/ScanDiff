...
class COCOSearch18TargetPresentDataset:
    def __init__(self, name: str, root_path: str, task: str, split: str, num_subjects: int, threshold: float = -1., threshold_no_dur: float = -1.,
                ...
                task_embeddings_file: str = 'task_embeddings.npy', img_features_dir: str = 'dinov2_base_timm_image_features_tp') -> None:
        self.name = name
        ...
        with open(Path(self.root_path, f'coco_search18_fixations_TP_{split}.json'), 'rb') as f:
    ...
    def __getitem__(self, index: int):
        ...
        original_img_size = Image.open(Path(self.root_path, 'images_tp', task_string, Path(img_filename))).size
