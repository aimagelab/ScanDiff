...
fixation_root = './data/osie/processed_fixations'
processed_root = '/home/OSIE/processed'

json_data_train = os.path.join(fixation_root, 'osie_fixations_train.json')
json_data_validation = os.path.join(fixation_root, 'osie_fixations_validation.json')
json_data_test = os.path.join(fixation_root, 'osie_fixations_test.json')
...
np.save(join('clusters_osie_512_384.npy'), clusters, allow_pickle=True)
